...
export default function LandingPage() {
  ...
  return (
    <main className="w-full min-h-screen bg-solo-bg text-solo-text selection:bg-solo-accent selection:text-solo-bg overflow-x-hidden cursor-none transition-colors duration-800">
      ...
      <section className="pt-24 md:pt-40 pb-16 md:pb-24 px-6 md:px-12 max-w-[1400px] mx-auto">
      ...
      <section className="pt-8 md:pt-12 pb-24 md:pb-40 px-6 md:px-12 max-w-[1400px] mx-auto">
        <motion.div
